...
extension ThemeExtension on BuildContext {
  ...
  TextStyle get headline5 => theme.textTheme.headline5!.copyWith(
      fontSize: 18, color: primaryLightColor, fontWeight: FontWeight.w400);
  TextStyle get headline6 => theme.textTheme.headline6!.copyWith(
      fontSize: 16, color: primaryLightColor, fontWeight: FontWeight.w400);
}
